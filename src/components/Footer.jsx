          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              ...
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div
                  role="tooltip"
                  className="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 p-3 rounded-lg bg-gray-800 text-gray-200 text-xs leading-relaxed text-left shadow-xl ring-1 ring-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-20"
                >
                  We use cookies to improve your browsing experience, analyze
                  site traffic, and remember your preferences. By continuing to
